...
# accelerate launch -m adapters.experiment 
...
# Config argparser
parser = argparse.ArgumentParser(description="Run experiments on BERT for a GLUE task (adapters)")
...
# Config directories
run_id = f"{checkpoint}-glue-{task_name}-adapters-bottleneck_size-{bottleneck_size}-n_epochs-{n_epochs}-seed-{seed}"
