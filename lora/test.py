...
# Config directories
out_dir = f"./outputs/LoRA/submission-{checkpoint}"
...
# Load model
model_path = f"./models/lora/{checkpoint}-glue-{"mnli" if task_name in ("mnli-m", "mnli-mm", "ax") else task_name}"
model = BertWithLoRA.from_pretrained(save_dir=model_path)
